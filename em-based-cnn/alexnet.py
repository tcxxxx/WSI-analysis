...
class AlexNet(object):
    ...
    def load_initial_weights(self, session, trainablev, skipLayers):
        ...
        for op_name in weights_dict:
            ...
            if not self.SKIP_LAYER and not (op_name in skipLayers):
                ...
                with tf.variable_scope(op_name, reuse=True):
                    ...
                    for data in weights_dict[op_name]:
                        ...
                        # Biases
                        if len(data.shape) == 1:
                            var = tf.get_variable('biases', trainable=trainablev)
                        ...
                        # Weights
                            ...
                            var = tf.get_variable('weights', trainable=trainablev)
                            session.run(var.assign(data))
                            print(var)
                            # print(data)
